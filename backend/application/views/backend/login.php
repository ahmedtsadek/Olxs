	...
	<div class='row justify-content-center'>
		<div class='col-8 col-md-5'>
			...
			<div class="form-group">
				...
				<input class="form-control" id="user_email" type="text" placeholder="<?php echo get_msg( 'user_email' ); ?>" name='email' value="<?php echo set_value( 'email' ); ?>">
			</div>
			
			<div class="form-group">
				<label><font color="#000"><?php echo get_msg( 'user_password' ); ?></font></label>
				<input class="form-control" id="user_password" type="password" placeholder="<?php echo get_msg( 'user_password' ); ?>" name='password' value="<?php echo set_value( 'password' ); ?>">
			</div>
