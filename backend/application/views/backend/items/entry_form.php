<?php
$attributes = ['id' => 'item-form', 'enctype' => 'multipart/form-data'];
    ...
    <form role="form">
        <div class="card-body">
        	<div class="row">
              ...
              <div class="form-group" id="item_type_id">
                <label>
              ...
              <div class="form-group" id="item_location">
                <label><span style="font-size: 17px; color: red;">*</span>
                ...
                echo form_dropdown(
                    ...
                    set_value(
                        'item_location_id',
                        show_data(@$item->item_location_id),
                        false
                    ),
              ...
              <div class="form-group" id="item_location_township">
                <label>
                ...
                <?php if (isset($item)) {
                    ...
                    $townships = $this->Item_location_township->get_all_by(
                        $conds
                    );
                    ...
                    echo form_dropdown(
                        ...
                        set_value(
                            'item_location_township_id',
                            show_data(@$item->item_location_township_id),
                            false
                        ),
              ...
              <div class="form-group" id="deal_option_id">
                  <label>
              ...
              <div class="form-group" id="deal_option_remark">
                <label>
                ...
                <?php echo form_textarea([
                    ...
                    'value' => set_value(
                        'deal_option_remark',
                        show_data(@$item->deal_option_remark),
                        false
                    ),
                    'class' => 'form-control form-control-sm',
                    'placeholder' => get_msg('deal_option_remark'),
                    'rows' => '3',
                ]); ?>
              ...
              <div class="form-group" id="highlight_info">
                <label>
              ...
              <div class="form-group" id="dynamic_link">
                <label>
                  <?php echo get_msg('prd_dynamic_link_label') .
                      ' : ' .
                      $item->dynamic_link; ?>
                </label>
              </div>

              <div class="form-group" id="owner_of_item">
                <label>
                  <?php echo get_msg('owner_of_item') .
                      ' : ' .
                      $this->User->get_one($item->added_user_id)->user_name; ?>
                </label>
              </div>
              
              <div class="form-group" style="padding-top: 30px;" id="status">
              ...
              <div class="form-group" id="business_mode">
                <div class="form-check">
                  <label>
                  ...
                  <?php echo form_checkbox([
                      ...
                      'checked' => set_checkbox(
                          'business_mode',
                          1,
                          @$item->business_mode == 1 ? true : false
                      ),
                      'class' => 'form-check-input',
                  ]); ?>
              ...
              <div class="form-group" id="is_sold_out">
                <div class="form-check">
                  <label>
            ...
            <div class="col-md-6" id="right">
              ...
              <div class="form-group" id="item_price_type_id">
                <label>
                ...
                echo form_dropdown(
                    ...
                    set_value(
                        'item_price_type_id',
                        show_data(@$item->item_price_type_id),
                        false
                    ),
              ...
              <div class="form-group" id="item_currency_id">
                <label><span style="font-size: 17px; color: red;">*</span>
                ...
                echo form_dropdown(
                    ...
                    set_value(
                        'item_currency_id',
                        show_data(@$item->item_currency_id),
                        false
                    ),
              ...
              <div class="form-group" id="discount_rate_by_percentage">
                ...
                <?php echo form_input([
                    ...
                    'value' => set_value(
                        'discount_rate_by_percentage',
                        show_data(@$item->discount_rate_by_percentage),
                        false
                    )
                        ? set_value(
                            'discount_rate_by_percentage',
              ...
              <div class="form-group" id="condition_of_item_id">
                <label>
                ...
                echo form_dropdown(
                    ...
                    set_value(
                        'condition_of_item_id',
                        show_data(@$item->condition_of_item_id),
                        false
                    ),
              ...
              <div class="form-group" id="image">
                ...
                <input class="btn btn-sm" type="file" name="cover" id="cover" accept=".jpg,.jpeg,.png">
              </div>
              <?php else: ?>
              <div id="image">
                <span style="font-size: 17px; color: red;">*</span>
                ...
                <div class="col-md-4" style="height:100">
                  ...
                  <div class="thumbnail">
                    ...
                    <p class="text-center">
                      <a data-toggle="modal" data-target="#deletePhoto" class="delete-img" id="<?php echo $images[0]->img_id; ?>"image="<?php echo $img->img_path; ?>">
              ...
              <div id="video">
                ...
                <?php
                  $conds = ['img_type' => 'video', 'img_parent_id' => $item->id];
                      ...
                      foreach ($videos as $video): ?>
                        ...
                        <div class="col-md-4">
                          ...
                          <video width="320" height="240" controls>
                              <source src="<?php echo $this->ps_image
                                  ->upload_url .
                                  $video->img_path; ?>" type="video/mp4" / >
              ...
              <?php if (!isset($item)): ?>
                <div class="form-group" id="video_icon">
              ...
              <div id="video_icon">
                ...
                <?php
                $conds = ['img_type' => 'video-icon', 'img_parent_id' => $item->id];
                $images = $this->Image->get_all_by($conds)->result();
                ?>
          ...
          <div class="gallery" id="gallery" style="margin-left: 15px; margin-bottom: 15px;">
            <?php
            $conds = ['img_type' => 'item', 'img_parent_id' => $item->id];
            $images = $this->Image->get_all_by($conds)->result();
            ?>
            <?php
            $i = 0;
