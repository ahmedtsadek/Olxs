	...
	<table class="table m-0 table-striped">
		<tr>
			...
			<?php if ( $this->ps_auth->has_access( PUBLISH )): ?>
				...
				<th><span class="th-title"><?php echo get_msg('deeplink_generator_label')?></span></th>
			...
			<tr>
				...
				<?php if ( $this->ps_auth->has_access( PUBLISH )): ?>
					...
					<td>
						...
						<a href="<?php echo site_url('/admin/items/deeplink_generate/'.$item->id); ?>" class="btn btn-sm btn-primary">
