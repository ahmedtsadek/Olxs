	...
	*/
	function touch_item_post()
	{
		...
		if($user_id != "") {
			...
			// } else {
			// 	$this->error_response( get_msg( 'invalid_user' ), 400);
			// }
	...
	function custom_response_history( $data, $user_id,$id, $require_convert = true )
	{
		...
		$item_config_object->brand = $item_config->brand;
		$item_config_object->lat = $item_config->lat;
		$item_config_object->lng = $item_config->lng;
		$item_config_object->business_mode = $item_config->business_mode;
		$item_config_object->sub_cat_id = $item_config->sub_cat_id;
		...
		$item_config_object->deal_option_id = $item_config->deal_option_id;
		$item_config_object->deal_option_remark = $item_config->deal_option_remark;
